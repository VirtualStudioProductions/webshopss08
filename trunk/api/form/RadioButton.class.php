...
class RadioButton extends Field {
	...
	public function get_display($value) {
		 ...
		 for ($i = 1; $i <= $count_options; $i++) {
		    ...
		    $replacement .= "".$caption_left." <input type=\"radio\" id=\"".$this->name."\" name=\"".$this->name."\" value=\"".htmlspecialchars($this->options[$i]->get_value())."\"".$this->options[$i]->get_css()."".$var." /> ".$caption_right."\n";
