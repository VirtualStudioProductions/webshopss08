	...
	<p>- Verantwortliche f&uuml;r den Shop -</p> <br />


	<h3>Anschrift</h3>
	
	<p>- Anschrift des Shops -</p> <br />
	
	
	<h3>Kontakt</h3>
	
	<p>- Kontaktdaten des Shops -</p> <br />
	
	
	<h3>Gestaltung &amp; Programmierung</h3>
	
	<p>Dieser Webshop wurde im Rahmen der Vorlesung "Webtechnologien"
	des Studiengangs Allgemeine Informatik an der FH-Ingolstadt im
	Sommersemester 2008 von folgenden Studenten entwickelt:</p>
	
	<p>Andreas Schmidl,<br />
	Thomas Schl&auml;fer,<br />
	Alexander Weickmann</p> <br />
	...
	ohne gesonderte Ank&uuml;ndigung zu ver&auml;ndern, zu erg&auml;nzen, zu
	...
	des Autors liegen, w&uuml;rde eine Haftungsverpflichtung ausschlie&szlig;lich
	in dem Fall in Kraft treten, in dem der Autor von den Inhalten Kenntnis hat
	und es ihm technisch m&ouml;glich und zumutbar w&auml;re, die Nutzung
	...
	gilt f&uuml;r alle innerhalb des eigenen Internetangebotes gesetzten Links
	und Verweise sowie f&uuml;r Fremdeintr&auml;ge in vom Autor eingerichteten
	...
	Allein aufgrund der blo&szlig;en Nennung ist nicht der Schluss
	zu ziehen, dass Markenzeichen nicht durch Rechte Dritter gesch&uuml;tzt sind!<br />
	Das Copyright f&uuml;r ver&ouml;ffentlichte, vom Autor selbst erstellte
	Objekte bleibt allein beim Autor der Seiten. Eine Vervielf&auml;ltigung oder
	Verwendung solcher Grafiken, Tondokumente, Videosequenzen und Texte in
	anderen elektronischen oder gedruckten Publikationen ist ohne ausdr&uuml;ckliche
	...
	Verst&ouml;ssen gegen dieses Verbot sind ausdr&uuml;cklich vorbehalten.</p>
	...
	in ihrem Inhalt und ihrer G&uuml;ltigkeit davon unber&uuml;hrt.</p><br />
	...
	completely deleted by the author without separate announcement.</p>
	...
	from viewing those pages. If any damage occurs by the use of
	...
	Any duplication or use of objects such as images, diagrams, sounds or
	texts in other electronic or printed publications is not permitted
	without the author's agreement.</p>
	
	<p>4. Privacy policy<br />
	If the opportunity for the input of personal or business data
	(email addresses, name, addresses) is given, the input of these data
	takes place voluntarily. The use and payment of all offered services
	are permitted - if and so far technically possible and reasonable -
	without specification of any personal data or under specification
	of anonymized data or an alias. The use of published postal addresses,
	...
	parts remain uninfluenced by this fact.</p> <br />
	
	
	<h3>Technische Informationen</h3>
	
	<p>Dieses Angebot ist unter den folgenden Adressen zu erreichen:<br />
	- URLs auflisten -</p>
	
	<p>Die Webseite ist mit minimalen grafischen Unterschieden auf allen
