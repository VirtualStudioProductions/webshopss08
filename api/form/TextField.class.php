...
class TextField extends Field {
	...
	public function get_display($value) {
		...
		return "<input type=\"text\" id=\"".$this->name."\" name=\"".$this->name."\" value=\"".htmlspecialchars($value[0])."\" maxlength=\"".$this->maxlength."\"".$this->css." dir=\"".$FIELD->get_v_dir()."\" ".$FIELD->get_actions().$FIELD->get_v_readonly()." />";
